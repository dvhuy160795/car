                ...
                <div class="row">
                    <div class="col-md-6 col-lg-12 col-sm-12 col-xs-12">
                        ...
                        <table class="table table-bordered">
                            ...
                            <?php $i++; }
                            ?>
                            <tr><td colspan="9" style="border: none"><a href="?control=mngOrder&action=OrderUser" >Xem thêm</a> </td></tr>
                        </table>
                        ...
                        foreach ($getorderkhach as $row){
                            ...
                            <?php $j++; } echo date('d/m/Y');?>
                                <tr><td colspan="9" style="border: none"><a href="?control=mngOrder&action=OrderKhach" >Xem thêm</a> </td></tr>
                        </table>
                        <!-- Pagination -->
